...
'\x1b[1;91m'   Author      :  BD-ADNAN

'\x1b[1;92m'   Github      :     Adnan-143

'\x1b[1;93m'   FB ID       :    ADNAN WASIF SHAKIL

'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS

'\x1b[1;96m'   WAP NUMBER  :     01758329292        
...
ADNANuser = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'

header= {"x-fb-connection-bandwidth": str(random.randint(20000000.0, 30000000.0)), "x-fb-sim-hni": str(random.randint(20000, 40000)), "x-fb-net-hni": str(random.randint(20000, 40000)), "x-fb-connection-quality": "EXCELLENT", "x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA", "user-agent":ADNANuser, "content-type": "application/x-www-form-urlencoded", "x-fb-http-engine": "Liger"}
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In ADNAN Paid Commands ")
        ...
        os.system("git clone https://www.facebook.com/jonising.com12")
        ...
        os.system("xdg-open https://wa.me/+88
